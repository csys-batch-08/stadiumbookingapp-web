...
<body>
    ...
    <div id="pickSeats">
        <div id="matchContrainer">
            <div class="mathcInfo">
                <div>
                    <img src="assets/image/${match.teamAlogo}" alt="teamA logo"> <strong id="Vs">Vs</strong> <img src="assets/image/${match.teamBlogo}" alt="can't find" id="temaBLogo"> <br /> <br /> <strong id="teamA">${match.teamA}</strong> <strong id="teamB">${match.teamB}</strong>
                    <br>
                </div>
                <br>
                <div id="matchDetails">
                    ...
                    <br>
                    <fmt:formatDate pattern="dd/MM/yyyy" value="${macthDate}" /> &nbsp; &nbsp; ${match.matchTime} <br>
                </div>
            </div>
            <br>. <br>
            ...
            <div class="stadium-container">
                <form action="booking">
                    <input type="hidden" id="matchId" value="${match.matchId}" name="matchIds" min="1"> <br> <label for="ticketNumber"><strong>Seat Number:</strong></label> <input type="text" id="ticketNumber" name="ticketNumber" readonly="readonly">
                    ...
                    <input type="number" id="count" name="seatCounts" min="1" max="100" required> &nbsp;&nbsp;&nbsp; <label for="total"><strong>Total Price (Rs):</strong></label>
