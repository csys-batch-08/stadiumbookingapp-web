<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	pageEncoding="ISO-8859-1"%> <%@taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%> <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <c:forEach items="${stadiumList}" var="stadiumList">
        <div class="rating">
            <img src="assets/image/${stadiumList.stadiumImg}" alt="${stadiumList.stadiumImg}"> <br> <strong>${stadiumList.stadiumName}</strong>
            <br/>
            <c:forEach items="${stadiumList.ratings}" var="ratingList">
                ...
                <div class="reviewContainer">
                    <img src="assets/image/${ratingList.user.profilePic}" alt="${ratingList.user.profilePic}" class="userProfile" data-aos="fade-up"> <strong class="reviwerName" data-aos="fade-up">${ratingList.user.name} &nbsp; <c:choose>
                    ...
                    </c:choose> &nbsp; <br> <br> <label id="review" data-aos="zoom-out">${ratingList.reviews}</label>
                    <br>
                </div>
            </c:forEach>
            <br>
