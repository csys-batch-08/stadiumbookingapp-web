...
<body>
	...
	<c:forEach items="${stadiumList}" var="stadiumList">
		...
		<div class="rating">
			<img src="assets/image/${stadiumList.stadiumImg}"
				alt="${stadiumList.stadiumImg}"> <br> <strong>${stadiumList.stadiumName}</strong>
			<br>


			<c:forEach items="${stadiumList.ratings}" var="ratingList">
				<jsp:useBean id="userDao"
					class="com.stadiumbooking.daoimpl.UserDaoImpl" />


				<div class="reviewContainer">
					<img src="assets/image/${ratingList.user.profilePic}"
						alt="${ratingList.user.profilePic}" class="userProfile"
						data-aos="fade-up"> <strong class="reviwerName"
						data-aos="fade-up">${ratingList.user.name} &nbsp; <c:choose>
					...
					&nbsp; <br> <br> <label id="review" data-aos="zoom-out">${ratingList.reviews}</label>
					<br>
