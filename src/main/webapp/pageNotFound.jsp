...
<body>
	...
	<div
		class="container animate__animated animate__fadeInDown animate__fast ">
		<div class="row">
			<div class="col-md-12">
				<div class="error-template">
					...
					<h2>404 Not Found</h2>
					<img
						class="img-fluid w-50 animate__animated animate__zoomIn animate__delay-1s"
						alt="can't find"
						src="assets/image/error-icon-32-removebg-preview.png">
